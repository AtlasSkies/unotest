...
const axisTitlesPlugin = {
	...
	afterDraw(chart) {
		...
		// --- CORRECTION: Get dynamic colors from chart options ---
		...
		// --- CORRECTION: Apply dynamic colors ---
...
function makeRadar(ctx, color, withBackground = false) {
	return new Chart(ctx, {
		...
		options: {
			...
			// --- CORRECTION: Set axis title colors for the main charts ---
			axisTitleColors: {
				strokeColor: color,
				fillColor: 'white'
			},
...
function refreshAll() {
	charts.forEach(obj => {
		...
		// Update individual chart axis colors whenever the color is changed
		obj.chart.options.axisTitleColors.strokeColor = obj.color;
...
viewBtn.addEventListener('click', () => {
	...
	// --- CORRECTION: Get the color of the first chart for the axes ---
	...
	radarPopup = new Chart(ctx, {
		...
		options: {
			...
			// --- CORRECTION: Set the axis title colors to the first chart's color ---
			axisTitleColors: {
